import { Component, ViewContainerRef, ViewChild, OnInit, HostBinding } from '@angular/core';
...
@Component({
  selector: 'app-org',
  templateUrl: './employment-visa.html',
  styleUrls: ['./employment-visa.css'],
})

export class EmploymentVisaComponent {
